/**
 * Club Hub access contract
 * ------------------------
 * Client UI checks (canEditClubHubPage, nav links, page gates) may use live
 * clubHubSponsors overrides via sponsorOverrides.
 *
 * Firestore and Storage rules only honor synced clubHubAccess maps
 * (directoryClubSlugs, manualClubSlugs). Writes require POST
 * /api/club-hub/sync-sponsor-access after login so override-only sponsors
 * receive directoryClubSlugs before editing pages or events.
 */
