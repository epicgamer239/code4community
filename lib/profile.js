 ...
 * @param {{ role?: string, writingCenterRole?: string, writingCenterAdmin?: boolean, email?: string } | null | undefined} userData
 */
export function resolveWritingCenterViewRole(userData) {
  if (isWritingCenterAdminUser(userData, userData?.email)) return "ADMIN";
